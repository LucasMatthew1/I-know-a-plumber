      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-2xl mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border border-slate-200/80 text-slate-700 text-xs font-medium mb-3">
            <Wrench className="w-4 h-4 text-[#0284C7]" weight="bold" />
          ...
          <p className="text-slate-600 text-sm sm:text-base mt-2.5 leading-relaxed">
            Straightforward plumbing services and project support. Choose a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-7">
          {servicesList.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="group flex flex-col justify-between bg-white rounded-2xl border border-slate-200/80 hover:border-slate-300 hover:shadow-md transition-all duration-200 overflow-hidden"
              >
                <div>
                  {/* Photo Header */}
                  <div className="relative h-44 overflow-hidden bg-slate-50">
                    ...
                    <span className="absolute bottom-3 left-3 text-xs font-medium text-white bg-[#0B2545]/80 backdrop-blur-sm px-2.5 py-1 rounded-full border border-white/20">
                      {service.highlight}
                    </span>
                  </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-2.5">
                      <div className="w-9 h-9 rounded-lg bg-sky-50 text-[#0284C7] flex items-center justify-center shrink-0">
                ...
                <div className="px-6 pb-5 pt-2 border-t border-slate-100 flex items-center justify-between">
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-xs font-semibold text-[#0369a1] hover:text-[#0B2545] transition-colors"
                  >
        ...
        {/* Minimal Banner */}
        <div className="mt-12 bg-slate-50/80 border border-slate-200/80 rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0 w-full sm:w-auto">
            <Button
              ...
              className="bg-[#0B2545] hover:bg-[#081b33] text-white font-medium text-xs sm:text-sm px-5 h-10 rounded-full w-full sm:w-auto shadow-sm"
            >
